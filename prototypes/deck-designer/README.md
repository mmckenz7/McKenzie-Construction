...
- A provider-free, read-only site-context compatibility projection plus a dormant local-overlay readiness preview for future reuse of Fence's promoted map adapter; no active Google runtime or map authority
