...
- A provider-free Deck domain-to-scene wrapper over the platform-owned read-only site-map core, plus a dormant local-overlay readiness preview; no active Google runtime or map authority
