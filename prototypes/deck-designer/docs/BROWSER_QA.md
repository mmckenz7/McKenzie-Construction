...
- Offset actions identify their matching plan segments by visible length and horizontal/vertical direction instead of unexplained edge numbers. Selecting a white square shows a simple read-only Length measurement rather than distance from the house.
