...
V5 layout review also retains the complete multi-beam warning authority instead of downgrading through the legacy single-beam compatibility shape. Every recorded cutout deterministically identifies the exact conceptual beam lines and joist paths it interrupts. These are non-blocking field-review facts: the prototype does not invent headers, trimmers, member sizes, spans, connections, footings, or structural adequacy. Stair and house collisions remain blockers because the recorded geometry overlaps; framing interruptions remain review notes because a qualified framing design could resolve them.
