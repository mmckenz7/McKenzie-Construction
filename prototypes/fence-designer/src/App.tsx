...
export default function App() {
  ...
  }), 700 * dimensionScale, 170 * dimensionScale).map((placement) => [placement.id, placement.position])), [design, dimensionScale, dimensionSideOverrides]);
