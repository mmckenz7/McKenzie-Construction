...
98. At 844 × 390 landscape, the three walk actions shared one compact row above a 500 px-high plan, the header/footer remained hidden, only zoom and Finish Walk remained in the toolbar, and the document had no horizontal overflow.
