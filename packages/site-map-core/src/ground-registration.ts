import { normalizedMapCoordinate, type NormalizedMapCoordinate } from "./map-presentation.js";

const EARTH_RADIUS_METERS = 6_378_137;

export const SITE_MAP_GROUND_PLANE = "MCKENZIE_LOCAL_MM" as const;
export type SiteMapGroundPlane = typeof SITE_MAP_GROUND_PLANE;
