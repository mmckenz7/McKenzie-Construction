...
export function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-brand-charcoal/10 bg-white p-4 shadow-sm">
      ...
      <p className="mt-2 text-sm uppercase tracking-[0.2em] text-brand-charcoal/70">
        {label}
      </p>
    </div>
  );
...
export function ProjectCard({
  ...
  const content = (
    <article className="group overflow-hidden rounded-[1.75rem] border border-brand-charcoal/10 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="p-7">
        ...
        {href ? (
          <p className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-brand-charcoal transition group-hover:text-brand-green">
            View Project
...
export function CTAButton({
  ...
  return (
    <Link
      href={href}
      className="rounded-full bg-brand-green px-6 py-3 text-center text-sm font-semibold text-brand-charcoal transition hover:opacity-90"
    >
      {children}
    </Link>
  );
...
export function OutlineButton({
  ...
  return (
    <Link
      href={href}
      className="rounded-full border border-brand-charcoal/20 bg-transparent px-6 py-3 text-center text-sm font-semibold text-brand-charcoal transition hover:border-brand-green hover:text-brand-green"
    >
      {children}
    </Link>
  );
